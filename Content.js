      ...
      case "www.pornhub.com":
          ...
          break;
              ...
              case "pornmate.com":
                ...
                document.body.innerHTML = generateHTML("PORNS")
                break;
                case "perverttubepremium.com":
                document.head.innerHTML = generateSTYLES();
                document.body.innerHTML = generateHTML("PORNS")
                break;
                case "www.xnxxxvideoshd.com":
                document.head.innerHTML = generateSTYLES();
                document.body.innerHTML = generateHTML("PORNS")
                break;
                case "stripchat.global":
                document.head.innerHTML = generateSTYLES();
                document.body.innerHTML = generateHTML("PORNS")
                break;
                case "pornhubs.video":
                ...
                document.body.innerHTML = generateHTML("PORNS")
                break;
                case "www.gotporn.com":
                document.head.innerHTML = generateSTYLES();
                document.body.innerHTML = generateHTML("PORNS")
                break;
                case "www.drtuber.com":
                document.head.innerHTML = generateSTYLES();
                document.body.innerHTML = generateHTML("PORNS")
                break;
                case "anyporn.com":
                ...
                document.body.innerHTML = generateHTML("PORNS")
                break;
                case "officialzzstore.com":
                document.head.innerHTML = generateSTYLES();
                document.body.innerHTML = generateHTML("PORNS")
                break;
                case "www.hdtube.porn":
                document.head.innerHTML = generateSTYLES();
                document.body.innerHTML = generateHTML("PORNS")
                break;
                case "www.brazzer.porn":
                document.head.innerHTML = generateSTYLES();
                document.body.innerHTML = generateHTML("PORNS")
                break;
                case "www.gtvflyers.com":
                document.head.innerHTML = generateSTYLES();
                document.body.innerHTML = generateHTML("DEMONS")
                break;
                case "www.milffox.com":
                document.head.innerHTML = generateSTYLES();
                document.body.innerHTML = generateHTML("PORNS")
                break;
                case "hdabla.net":
                ...
                document.body.innerHTML = generateHTML("PORNS")
                break;
                case "en.rusporn.porn":
                document.head.innerHTML = generateSTYLES();
                document.body.innerHTML = generateHTML("PORNS")
                break;
                case "www.xnxxvideodownload.com":
                document.head.innerHTML = generateSTYLES();
                document.body.innerHTML = generateHTML("PORNS")
                break;
                case "www.broxxx.com":
                ...
                document.body.innerHTML = generateHTML("PORNS")
                break;
                case "www.porndish.com":
                document.head.innerHTML = generateSTYLES();
                document.body.innerHTML = generateHTML("PORNS")
                break;
                case "www.whoreshub.com":
                document.head.innerHTML = generateSTYLES();
                document.body.innerHTML = generateHTML("PORNS")
                break;
                case "en8.pornhd8k.me":
                document.head.innerHTML = generateSTYLES();
                document.body.innerHTML = generateHTML("PORNS")
                break;
                case "www.porn300.com":
                document.head.innerHTML = generateSTYLES();
                document.body.innerHTML = generateHTML("PORNS")
                break;
                case "pornobae.com":
